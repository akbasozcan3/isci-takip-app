...
class Database {
  ...
  loadData() {
    ...
    return {
      ...
      emailVerifications: {},
      emailResets: {},
      passwordResetTokens: {}, // token -> { email, userId, expiresAt }
      resendMeta: {},
      store: {},
      articles: {},
      notifications: {}, // userId -> array of notifications
      billingEvents: {},
      // --- Groups feature ---
      groups: {},              // id -> group
      groupMembers: {},        // groupId -> { userId: role }
      groupRequests: {}        // groupId -> { requestId: request }
    };
  }
