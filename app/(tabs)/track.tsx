    ...
    <SafeAreaView style={styles.safe} edges={["top"]}>
      ...
      <LinearGradient colors={["#06b6d4", "#0ea5a4"]} style={styles.headerWrap} start={[0, 0]} end={[1, 1]}>
        ...
        {selectedGroup && (
          <Pressable 
            onPress={() => setShowGroupSelector(true)} 
            style={styles.groupInfoBanner}
            android_ripple={{ color: 'rgba(255,255,255,0.15)' }}
          >
            <LinearGradient
              colors={['rgba(124,58,237,0.2)', 'rgba(6,182,212,0.2)']}
              start={[0, 0]}
              end={[1, 0]}
              style={styles.groupInfoGradient}
            >
              <Ionicons name="people-circle" size={18} color="#fff" style={{ marginRight: 8 }} />
              <View style={{ flex: 1 }}>
                <Text style={styles.groupInfoName}>{selectedGroup.name}</Text>
                <Text style={styles.groupInfoStats}>
        ...
        <View style={styles.headerStats}>
          ...
          <Text style={styles.statText}>{accuracyMeters != null && isFinite(accuracyMeters) ? `${Math.round(accuracyMeters)} m` : '-'}</Text>
      ...
      <ScrollView contentContainerStyle={{ paddingBottom: 140 }}>
        ...
        <View style={styles.controlPanel}>
          ...
          <View style={styles.metricsRow}>
            ...
            <View style={styles.metricItem}><Text style={styles.metricLabel}>Doğruluk</Text><Text style={styles.metricVal}>{accuracyMeters != null && isFinite(accuracyMeters) ? `${Math.round(accuracyMeters)} m` : '-'}</Text></View>
            ...
            <View style={styles.metricItem}><Text style={styles.metricLabel}>Grup Mesafe</Text><Text style={styles.metricVal}>{formatDistance(distanceToGroup)}</Text></View>
          </View>
        </View>
      </ScrollView>
                ...
                >
                  ...
                  <View style={styles.trackInfoStep}>
                    <View style={styles.trackInfoStepHeader}>
                      <View style={[styles.trackInfoStepNumber, { backgroundColor: '#06b6d4' }]}>
                      ...
                      <View style={styles.trackInfoStepContent}>
                        <View style={styles.trackInfoStepTitleRow}>
                          <Ionicons name="people-circle" size={20} color="#06b6d4" />
