        ...
        try {
          ...
          if (healthResponse.ok) {
            ...
            try {
              ...
              const billingResponse = await authFetch('/api/billing/plans');
              ...
              console.warn('[Settings] Billing info fetch error:', err);
            }
          } else {
  ...
  return (
    <SafeAreaView style={styles.container} edges={["top"]}>
      ...
      <ScrollView style={styles.content} contentContainerStyle={{ paddingBottom: 140 }}>
        ...
        <View style={styles.section}>
          <LinearGradient colors={['#181826', '#0f0f1a']} style={styles.subscriptionCard}>
            <View style={styles.subscriptionBadge}>
              <Ionicons name="sparkles" size={16} color="#c084fc" />
              <Text style={styles.subscriptionBadgeText}>Pro avantajları</Text>
            </View>
            ...
            >
              <Text style={styles.subscriptionButtonText}>Planları incele</Text>
            ...
            >
              <View style={styles.menuLeft}>
                ...
                <View style={styles.menuTextContainer}>
                  ...
                  <Text style={styles.menuDescription}>Şifrenizi sıfırlamak için e-posta adresinize onay linki gönderilir</Text>
                </View>
              </View>
